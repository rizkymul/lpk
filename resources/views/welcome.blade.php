...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class='main'>
            ...
            @foreach($a as $c)
                {{$c->id}}
                <a href="{{route('content.edit', $c->id)}}" class="btnredpanjang">{{$c->content1}}</a>
            @endforeach
                ...
                <div class='listKontenVisimisi'>
                    ...
                    <div class='containerVisimisi'>
                        <div class='cardVisimisi'>
                            ...
                            <p class='textCardVisimisi'>Menjadi lembaga Pendidikan yang berkualitas dalam membentuk karakter siswa yang ber-etos kerja tinggi</p>
                        </div>
                        <div class='cardVisimisi'>
                            <p class='judulCardVisimisi'>Misi</p> 
                            <p class='textCardVisimisi'>Menyelenggarakan Pendidikan Bahasa jepang yang unggul dan kompetitif dan
            ...
            <section class='programTD'>
                ...
                <div class='listProYD'>
                    <div class='cardProYD'>
                        ...
                        <div class="contentProYD">
                            ...
                            <p class='p2ProYD'>Pembelajaran khusus untuk mempersiapkan siswa-siswa menghadapi seleksi IM Japan,
                ...
                <div class='listProYD'>
                    <div class='cardProYD'>
                        <div class='garisVred'></div>
                        <div class="contentProYD">
                            <p class='p1ProYD'>Program Belajar Bahasa Jepang N4 Untuk Persiapan Tokuteiginou / Visa Kerja</p>
                            <p class='p2ProYD'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</p>
                            <p class='selengkapnya'>Persyaratan Selengkapnya</p>
                        </div>
                    </div> 
            ...
            <div style="width: 100%">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d9580.797657654426!2d106.82686244598949!3d-6.176687062652464!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e69f5d2e764b12d%3A0x3d2ad6e1e0e9bcc8!2sMonumen%20Nasional!5e0!3m2!1sid!2sid!4v1737467393618!5m2!1sid!2sid" allowfullscreen="" loading="lazy" style="border: none; width:100%; height:400px; "referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
